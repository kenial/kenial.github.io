...
위 단락의 인용문을 읽으며 혹시 **뭐? 구글하고 스타트업 시니어 개발자의 급여 수준이 비슷하다고?** 라고 생각했을지 모르겠다. 저 주장에는 많은 부분이 생략되어 있고, 해당 회사가 어느 단계의 스타트업인지 (엔젤 투자, 시드, 시리즈 X, 피인수, IPO..) 모르고서는 급여에 대해 논의하기 어렵기 때문이다. 쉽게 유추 가능하겠지만, 이른 단계에 있는 스타트업일수록 연봉보다는 스톡 옵션의 비중이 높은 경향이 있다. (그리고 당연하지만, 회사 자체가 망할 확률도 높다)
